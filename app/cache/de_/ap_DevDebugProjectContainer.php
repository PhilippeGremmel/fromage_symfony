...
class ap_DevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/phil/Documents/site/Symfony2/app/cache/de_/annotations', true);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $h->setProxyDir('/Users/phil/Documents/site/Symfony2/app/cache/de_/doctrine/orm/Proxies');
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/phil/Documents/site/Symfony2/app/cache/de_/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/phil/Documents/site/Symfony2/app/cache/de_/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/phil/Documents/site/Symfony2/app/cache/de_/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/phil/Documents/site/Symfony2/app/cache/de_/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/phil/Documents/site/Symfony2/app/cache/de_');
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.annotation_driver'), $this->get('vich_uploader.adapter'), array('product_image' => array('uri_prefix' => '/images', 'upload_destination' => '/Users/phil/Documents/site/Symfony2/app/../web/images', 'namer' => NULL, 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true, 'inject_on_load' => true)));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/Users/phil/Documents/site/Symfony2/app/cache/de_',
            ...
            'debug.container.dump' => '/Users/phil/Documents/site/Symfony2/app/cache/de_/ap_DevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Users/phil/Documents/site/Symfony2/app/cache/de_/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Users/phil/Documents/site/Symfony2/app/cache/de_/profiler',
            ...
            'router.resource' => '/Users/phil/Documents/site/Symfony2/app/cache/de_/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/phil/Documents/site/Symfony2/app/cache/de_/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/phil/Documents/site/Symfony2/app/cache/de_/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/phil/Documents/site/Symfony2/app/cache/de_/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/phil/Documents/site/Symfony2/app/cache/de_/doctrine/orm/Proxies',
            ...
            'vich_uploader.mappings' => array(
                'product_image' => array(
                    'uri_prefix' => '/images',
                    'upload_destination' => '/Users/phil/Documents/site/Symfony2/app/../web/images',
                    'namer' => NULL,
